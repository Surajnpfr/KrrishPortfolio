...
const Loader = ({ onComplete }) => {
    ...
    return (
        ...
        >
            <div ref={flashRef} className="absolute inset-0 bg-white opacity-0 pointer-events-none z-[110]" aria-hidden="true"></div>
            ...
            <div className="container mx-auto px-6 h-full flex flex-col md:flex-row items-center justify-center gap-12 md:gap-24">
                ...
                <div ref={imgRef} className="relative w-64 h-64 md:w-96 md:h-96 shrink-0 aspect-square">
                    <div className="absolute inset-0 border border-white/20 rounded-full animate-[spin_10s_linear_infinite]" aria-hidden="true"></div>
                    <div className="absolute inset-4 border border-white/10 rounded-full animate-[spin_15s_linear_infinite_reverse]" aria-hidden="true"></div>
                    <img
                ...
                <div ref={textRef} className="text-center md:text-left flex flex-col items-center md:items-start">
                    ...
                    <div className="w-20 h-1 bg-white mb-6" aria-hidden="true"></div>
                    ...
                    <div className="mt-12 group flex items-center gap-3 text-sm tracking-[0.3em] uppercase text-zinc-400 animate-pulse">
                        <span>Click to Enter</span>
                        <div className="w-8 h-px bg-zinc-600 group-hover:w-16 transition-all" aria-hidden="true"></div>
                    </div>
                </div>
            </div>
        </div>
